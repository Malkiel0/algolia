...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('role')->default('client'); // Rôle de l'utilisateur (client, admin, vendeur, livreur, etc.)
            $table->string('status')->default('active'); // Statut du compte (active, inactive, banned, etc.)
