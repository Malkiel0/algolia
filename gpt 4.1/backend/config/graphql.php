...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                App\GraphQL\Queries\ShippingAddressesQuery::class,
                App\GraphQL\Queries\ShippingAddressQuery::class,
                App\GraphQL\Queries\ShippingMethodsQuery::class,
                App\GraphQL\Queries\ShippingMethodQuery::class,
                App\GraphQL\Queries\OrderShipmentsQuery::class,
                App\GraphQL\Queries\OrderShipmentQuery::class,
                // Ajout journal d'activité
                App\GraphQL\Queries\RecentActivitiesQuery::class,
            ],
            'mutation' => [
                App\GraphQL\Mutations\CreateUserMutation::class,
                App\GraphQL\Mutations\CreateProductMutation::class,
                App\GraphQL\Mutations\UpdateUserMutation::class,
                App\GraphQL\Mutations\UpdateProductMutation::class,
                App\GraphQL\Mutations\DeleteUserMutation::class,
                App\GraphQL\Mutations\DeleteProductMutation::class,
                App\GraphQL\Mutations\UpdateOrderMutation::class,
                App\GraphQL\Mutations\DeleteOrderMutation::class,
                App\GraphQL\Mutations\CreatePaymentMutation::class,
                App\GraphQL\Mutations\UpdatePaymentMutation::class,
                App\GraphQL\Mutations\DeletePaymentMutation::class,
                App\GraphQL\Mutations\CreateShippingAddressMutation::class,
                App\GraphQL\Mutations\UpdateShippingAddressMutation::class,
                App\GraphQL\Mutations\DeleteShippingAddressMutation::class,
                App\GraphQL\Mutations\CreateShippingMethodMutation::class,
                App\GraphQL\Mutations\UpdateShippingMethodMutation::class,
                App\GraphQL\Mutations\DeleteShippingMethodMutation::class,
                App\GraphQL\Mutations\CreateOrderShipmentMutation::class,
                App\GraphQL\Mutations\UpdateOrderShipmentMutation::class,
                App\GraphQL\Mutations\DeleteOrderShipmentMutation::class,
            ],
    ...
    'types' => [
        ...
        App\GraphQL\Types\OrderItemType::class,
        App\GraphQL\Types\PaymentType::class,
        App\GraphQL\Types\CreateOrderItemInputType::class,
        App\GraphQL\Types\ShippingAddressType::class,
        App\GraphQL\Types\ShippingMethodType::class,
        App\GraphQL\Types\OrderShipmentType::class,
        // Ajout du type Activity pour le journal d'activité
        App\GraphQL\Types\ActivityType::class,
    ],
